...
import 'package:titulacion_app/presentation/screens/division/menu/sidebar.dart';
...
class DivisionLayout extends StatefulWidget {
  final Widget child;

  const DivisionLayout({super.key, required this.child});

  @override
  State<DivisionLayout> createState() => _DivisionLayoutState();
}

class _DivisionLayoutState extends State<DivisionLayout>
