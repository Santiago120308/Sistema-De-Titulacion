    ...
    return Container(
      ...
      child: ListView(
        ...
        children: [
          ...
          const TextSeparator(text: "DIVISION HOME"),
          MenuItem(
              text: 'HOME',
              isActive: sideMenuProvider.currentPage == AppRouter.division,
              onPressed: () {
          ...
          ...carrerasProvider.carreras.map((carrera) {
            return MenuItem(
                ...
                onPressed: () async {
                  await carrerasProvider.cargarSolicitudes(carrera['id']);
                  if(context.mounted){
                    NavigationServiceGo.navigateTo(
                      context, '/division/${carrera['id']}');
                  }
                });
          }),
        ],
