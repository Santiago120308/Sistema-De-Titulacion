...
class GeneratedPdfOpcionX2004 extends PdfGenerator{
  @override
  Future<void> generatorPdf(DatosSolicitud solicitud) async {
    if(solicitud is SolicitudOpcionX2004){
        ...
        pw.Page(
          build: (pw.Context context) => pw
            ...
            pw.Container(
                width: double.infinity,
                padding: const pw.EdgeInsets.only(left: 10),
                child: pw.Text('Informe de residencia (Objetivo, Índice y Bibliografía)  ',
                    style: pw.TextStyle(font: pw.Font.times(), fontSize: 11),
                    textAlign: pw.TextAlign.start)),
            pw.Container(
                width: double.infinity,
