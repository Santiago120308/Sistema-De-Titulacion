...
class GeneratedPdfOpcionI2009 extends PdfGenerator {
  @override
        ...
        pw.Page(
          build: (pw.Context context) => pw
            ...
            pw.Container(
              width: double.infinity,
              padding: const pw.EdgeInsets.only(left: 10),
              child: pw.Text("Acta de Calificaciones de la Residencia",
                  // ignore: prefer_const_constructors
                  style: pw.TextStyle(
                    fontSize: 11,
                    fontWeight: pw.FontWeight.normal,
            ...
            pw.Container(
              ...
              padding: const pw.EdgeInsets.only(left: 10),
              child: pw.Text(
                  "Informe de Residencia (Objetivo, Índice y Bibliografía)",
                  // ignore: prefer_const_constructors
                  style: pw.TextStyle(
                    fontSize: 11,
                    fontWeight: pw.FontWeight.normal,
