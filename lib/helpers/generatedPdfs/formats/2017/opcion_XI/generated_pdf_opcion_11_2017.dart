...
class GeneratedPdfOpcionXI2017 extends PdfGenerator {
  @override
  Future<void> generatorPdf(DatosSolicitud solicitud) async {
    if (solicitud is SolicitudOpcionXI2017) {
        ...
        pw.Page(
          build: (pw.Context context) => pw
            ...
            pw.Container(
              ...
              child: pw.Text('ZACATEPEC MOR, $formattedDate',
                  style: pw.TextStyle(
                      fontSize: 12, fontWeight: pw.FontWeight.bold),
                ...
                children: [
                  ...
                  pw.TableRow(children: [
                    pw.Padding(
                        padding: const pw.EdgeInsets.symmetric(horizontal: 10),
                        child: pw.Text(
                            "d) Nombre de cada una de las áreas del examen: ",
                            style:
                                pw.TextStyle(fontWeight: pw.FontWeight.bold))),
                    pw.Padding(
                        padding: const pw.EdgeInsets.symmetric(horizontal: 10),
                        child: pw.Text(solicitud.areasExamen.toUpperCase(),
                            textAlign: pw.TextAlign.center,
                            style:
                                pw.TextStyle(fontWeight: pw.FontWeight.bold))),
                  ]),
            ...
            pw.Container(
              width: double.infinity,
              padding: const pw.EdgeInsets.only(left: 10),
              child: pw.Text("Constancia de Testimonio de Desempeño",
                  // ignore: prefer_const_constructors
                  style: pw.TextStyle(
                    fontSize: 11,
                    fontWeight: pw.FontWeight.normal,
            ...
            pw.Container(
              width: double.infinity,
              padding: const pw.EdgeInsets.only(left: 10),
              child: pw.Text("Reporte Individual de Resultados",
                  // ignore: prefer_const_constructors
                  style: pw.TextStyle(
                    fontSize: 11,
                    fontWeight: pw.FontWeight.normal,
