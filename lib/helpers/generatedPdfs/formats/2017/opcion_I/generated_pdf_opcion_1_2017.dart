...
class GeneratedPdfOpcionI2017 extends PdfGenerator {
  @override
  Future<void> generatorPdf(DatosSolicitud solicitud) async {
    if (solicitud is SolicitudGeneral2017) {
        ...
        pw.Page(
          build: (pw.Context context) => pw
            ...
            pw.Table(
                ...
                children: [
                  ...
                  pw.TableRow(children: [
                    ...
                    pw.Padding(
                        padding: const pw.EdgeInsets.symmetric(horizontal: 10),
                        child: pw.Text(solicitud.user['correo'],
                            textAlign: pw.TextAlign.center,
                            style:
                                pw.TextStyle(fontWeight: pw.FontWeight.bold))),
                  ]),
            ...
            pw.Container(
              ...
              padding: const pw.EdgeInsets.only(left: 10),
              child:
                  pw.Text("Acta de Calificaciones de la Residencia",
                      // ignore: prefer_const_constructors
                      style: pw.TextStyle(
                        fontSize: 11,
                        fontWeight: pw.FontWeight.normal,
            ...
            pw.Container(
              width: double.infinity,
              padding: const pw.EdgeInsets.only(left: 10),
              child: pw.Text("Residencia Profesional (Objetivo, Indice y Bibliografia)",
                  // ignore: prefer_const_constructors
                  style: pw.TextStyle(
                    fontSize: 11,
                    fontWeight: pw.FontWeight.normal,
