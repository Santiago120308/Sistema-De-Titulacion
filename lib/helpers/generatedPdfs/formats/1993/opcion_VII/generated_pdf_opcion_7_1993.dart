...
class GeneratedPdfOpcionVII1993 extends PdfGenerator {
  @override
  Future<void> generatorPdf(DatosSolicitud solicitud) async {
    if(solicitud is SolicitudGeneral1993){
      final pdf = pw.Document();
      DateTime now = DateTime.now();
      String formattedDate = "${now.day} de ${NombreMes.mesEnTexto(now.month)} del ${now.year}";
        ...
        build: (pw.Context context) => pw.Column(
          ...
          children: [
            ...
            pw.Container(
              ...
              child: pw.Text(
                "ASUNTO: SE SOLICITA AUTORIZACION PARA TITULACION",
          ...
          pw.Container(
            ...
            style: pw.TextStyle(
              font: pw.Font.times() , 
              fontSize: 11 , decoration: pw.TextDecoration.underline) , 
              textAlign: pw.TextAlign.start ,)
          ) , 
            ...
            child: pw.RichText(
              text:  pw.TextSpan(
                ...
                children: [
                  ...
                  pw.TextSpan(
                    text: '${solicitud.user['nombre']} ${solicitud.user['apellidos']} ' , 
                    ...
                    const pw.TextSpan(
                      text: 'me dirijo a Usted, para solicitar mi Titulación por medio de la opción ') ,   
                    ...
                    const pw.TextSpan(
                      text: 'del procedimiento académico para obtener el título de licenciatura en los institutos tecnológicos.') ,                                                
                ]
              )) ,  
          ) , 
           ...
           pw.Container(
            ...
            child: pw.RichText(
              ...
              style: pw.TextStyle(
                ...
                padding: const pw.EdgeInsets.only(left: 10),
                child: pw.Text(
                'ANEXO: Constancia de trabajo con innovaciones y mejoras,' , 
              style: pw.TextStyle(
                font: pw.Font.times() , 
                fontSize: 11) , 
                textAlign: pw.TextAlign.start)) , 
                ...
                padding: const pw.EdgeInsets.only(left: 10),
                child: pw.Text(
                'Objetivo, Índice y Bibliografía' , 
              style: pw.TextStyle(
                font: pw.Font.times() , 
                fontSize: 11) , 
                textAlign: pw.TextAlign.start)) , 
    ...
    await Printing.sharePdf(bytes: pdfBytes, filename: "${solicitud.user['nombre']} ${solicitud.user['apellidos']} solicitud.pdf");
    }
  }
