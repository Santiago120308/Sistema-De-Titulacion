...
class GeneratedPdfOpcionIII1993 extends PdfGenerator {
  @override
        ...
        pw.Page(
          build: (pw.Context context) => pw
            ...
            pw.Container(
              ...
              child: pw.RichText(
                  text: pw.TextSpan(
                    ...
                    const pw.TextSpan(
                        text:
                            'me dirijo a Usted, para solicitar mi Titulación por medio de la opción '),
                    pw.TextSpan(
            ...
            pw.Container(
                width: double.infinity,
                padding: const pw.EdgeInsets.only(left: 10),
                child: pw.Text('ANEXO: Objetivo, Índice y Bibliografía',
                    style: pw.TextStyle(font: pw.Font.times(), fontSize: 11),
                    textAlign: pw.TextAlign.start)),
            pw.Container(
                width: double.infinity,
                padding: const pw.EdgeInsets.only(left: 10),
                child: pw.Text('Constancia de participación en el proyecto',
                    style: pw.TextStyle(font: pw.Font.times(), fontSize: 11),
                    textAlign: pw.TextAlign.start)),
            pw.SizedBox(height: 40),
            pw.Container(
